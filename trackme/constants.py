...
BOT_TOKEN_EXPIRY_TIME = os.getenv('BOT_TOKEN_EXPIRY_TIME')
...
BATTERY_LEVEL_THRESHOLD = int(os.getenv('BATTERY_LEVEL_THRESHOLD'))

OPEN_API_KEY = os.getenv('OPEN_API_KEY')
OPEN_API_ENABLED = os.getenv('OPEN_API_ENABLED') == 'true'